...
namespace Apteco.ApiDataAggregator.ApiClient.Api
{
    /// <summary>
    ...
    public interface IAboutApi : IApiAccessor
    {
        ...
        /// EXPERIMENTAL
        /// </remarks>
        /// <exception cref="Apteco.ApiDataAggregator.ApiClient.Client.ApiException">Thrown when fails to make API call</exception>
    ...
    {
        private Apteco.ApiDataAggregator.ApiClient.Client.ExceptionFactory _exceptionFactory = (name, response) => null;
        ...
        public AboutApi(String basePath)
        {
            ...
            ExceptionFactory = Apteco.ApiDataAggregator.ApiClient.Client.Configuration.DefaultExceptionFactory;
        }
        ...
        /// </summary>
        public Apteco.ApiDataAggregator.ApiClient.Client.ExceptionFactory ExceptionFactory
        {
            get
            {
